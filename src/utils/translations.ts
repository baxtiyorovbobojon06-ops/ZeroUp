...
export const translations: TranslationsMap = {
  uz: {
    ...
    "notifications_enable": "Barcha bildirishnomalar",
    "notifications_enable_desc": "Vazifalar tekshirilib bo'lganda xabar berish",
    "save_btn": "Saqlash",
  ...
  ru: {
    ...
    "notifications_enable": "Все уведомления",
    "notifications_enable_desc": "Уведомлять о завершении проверки заданий",
    "save_btn": "Сохранить",
  ...
  en: {
    ...
    "notifications_enable": "All notifications",
    "notifications_enable_desc": "Notify when tasks grading is complete",
    "save_btn": "Save",
